...
const About = () => {
  return (
    <div
      name="about"
      className=" pt-[55rem] md:pt-0 w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-lg mt-20 text-justify">
          ...
          Information Technology from Poornima College of Engineering. A tech
          enthusiast passionate about merging the worlds of technology and
          innovation.{" "}
          <span className=" font-semibold text-blue-300">
            My skill set revolves around a fusion of Frontend Development, Data
            Science, Data Analytics, and Machine Learning.
          </span>{" "}
          My expertise spans across diverse domains. On one end, I thrive in
          crafting immersive frontend experiences, sculpting user interfaces
          that captivate and engage. Simultaneously, my love for numbers and
          patterns has led me into the realm of Data Science and Data Analytics,
          where I unravel insights from complex datasets. Moreover, my journey
          into Machine Learning involves crafting intelligent systems that learn
          and evolve.
        </p>
